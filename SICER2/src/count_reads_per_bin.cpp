...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "language": "c++",
        "name": "SICER2.src.count_reads_per_bin",
        "sources": [
            "SICER2/src/count_reads_per_bin.pyx"
        ]
    },
    "module_name": "SICER2.src.count_reads_per_bin"
}
END: Cython Metadata */
...
#define __PYX_HAVE__SICER2__src__count_reads_per_bin
#define __PYX_HAVE_API__SICER2__src__count_reads_per_bin
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'SICER2.src.count_reads_per_bin' */
...
static PyObject *__pyx_f_6SICER2_3src_19count_reads_per_bin_count_reads_per_bin(PyObject *, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "SICER2.src.count_reads_per_bin"
extern int __pyx_module_is_main_SICER2__src__count_reads_per_bin;
int __pyx_module_is_main_SICER2__src__count_reads_per_bin = 0;

/* Implementation of 'SICER2.src.count_reads_per_bin' */
...
static PyObject *__pyx_pf_6SICER2_3src_19count_reads_per_bin_count_reads_per_bin(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_tags); /* proto */
...
/* "SICER2/src/count_reads_per_bin.pyx":3
 * import numpy as np
 * 
...
static PyObject *__pyx_pw_6SICER2_3src_19count_reads_per_bin_1count_reads_per_bin(PyObject *__pyx_self, PyObject *__pyx_v_tags); /*proto*/
static PyObject *__pyx_f_6SICER2_3src_19count_reads_per_bin_count_reads_per_bin(PyObject *__pyx_v_tags, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  int __pyx_v_count;
  int __pyx_v_nparsed;
  PyObject *__pyx_v_bins_counts = NULL;
  PyObject *__pyx_v_k = NULL;
  PyObject *__pyx_v_bin_arr = NULL;
  ...
  __Pyx_RefNannySetupContext("count_reads_per_bin", 0);

  /* "SICER2/src/count_reads_per_bin.pyx":12
 *         cdef int last
 *         cdef int current
 *         cdef int count = 0             # <<<<<<<<<<<<<<
 *         cdef int nparsed
 ...
 */
  ...
  /* "SICER2/src/count_reads_per_bin.pyx":15
 *         cdef int nparsed
 * 
 *     bins_counts = dict()             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_v_bins_counts = ((PyObject*)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "SICER2/src/count_reads_per_bin.pyx":16
 * 
 *     bins_counts = dict()
 *     for k, v in tags.items():             # <<<<<<<<<<<<<<
 *         nparsed = 0
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_tags, __pyx_n_s_items); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 16, __pyx_L1_error)
  ...
  for (;;) {
    ...
    __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_dc_long(__pyx_t_6, PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 16, __pyx_L1_error)
    ...
    /* "SICER2/src/count_reads_per_bin.pyx":17
 *     bins_counts = dict()
 *     for k, v in tags.items():
 *         nparsed = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "SICER2/src/count_reads_per_bin.pyx":19
 *         nparsed = 0
 * 
 *         bin_arr = np.zeros(len(v), dtype=int)             # <<<<<<<<<<<<<<
 *         bins = bin_arr
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_zeros); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 19, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_10 = __Pyx_MemoryView_Len(__pyx_v_v); 
    __pyx_t_1 = __Pyx_PyInt_FromSize_t(__pyx_t_10); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    ...
    __Pyx_GOTREF(__pyx_t_1);
    if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, ((PyObject *)(&PyInt_Type))) < 0) __PYX_ERR(0, 19, __pyx_L1_error)
    __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 19, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_XDECREF_SET(__pyx_v_bin_arr, __pyx_t_7);
    __pyx_t_7 = 0;

    /* "SICER2/src/count_reads_per_bin.pyx":20
 * 
 *         bin_arr = np.zeros(len(v), dtype=int)
 *         bins = bin_arr             # <<<<<<<<<<<<<<
 *         count_arr = np.zeros(len(v), dtype=int)
 *         counts = count_arr
 */
    __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_dc_long(__pyx_v_bin_arr, PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 20, __pyx_L1_error)
    __PYX_XDEC_MEMVIEW(&__pyx_v_bins, 1);
    __pyx_v_bins = __pyx_t_9;
    __pyx_t_9.memview = NULL;
    __pyx_t_9.data = NULL;

    /* "SICER2/src/count_reads_per_bin.pyx":21
 *         bin_arr = np.zeros(len(v), dtype=int)
 *         bins = bin_arr
 *         count_arr = np.zeros(len(v), dtype=int)             # <<<<<<<<<<<<<<
 *         counts = count_arr
 ...
 */
    ...
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_10 = __Pyx_MemoryView_Len(__pyx_v_v); 
    __pyx_t_7 = __Pyx_PyInt_FromSize_t(__pyx_t_10); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 21, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    ...
    __Pyx_GOTREF(__pyx_t_7);
    if (PyDict_SetItem(__pyx_t_7, __pyx_n_s_dtype, ((PyObject *)(&PyInt_Type))) < 0) __PYX_ERR(0, 21, __pyx_L1_error)
    __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_3, __pyx_t_7); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 21, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_XDECREF_SET(__pyx_v_count_arr, __pyx_t_6);
    __pyx_t_6 = 0;

    /* "SICER2/src/count_reads_per_bin.pyx":22
 *         bins = bin_arr
 *         count_arr = np.zeros(len(v), dtype=int)
 *         counts = count_arr             # <<<<<<<<<<<<<<
 * 
 *         if len(v) >= 1:
 */
    __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_dc_long(__pyx_v_count_arr, PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 22, __pyx_L1_error)
    __PYX_XDEC_MEMVIEW(&__pyx_v_counts, 1);
    __pyx_v_counts = __pyx_t_9;
    __pyx_t_9.memview = NULL;
    __pyx_t_9.data = NULL;

    /* "SICER2/src/count_reads_per_bin.pyx":24
 *         counts = count_arr
 * 
 *         if len(v) >= 1:             # <<<<<<<<<<<<<<
 *             last = bins[0]
 ...
 */
    ...
    if (__pyx_t_11) {
      ...
      /* "SICER2/src/count_reads_per_bin.pyx":25
 * 
 *         if len(v) >= 1:
 *             last = bins[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_v_last = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_bins.data) + __pyx_t_12)) )));
 ...
 */
    ...
    /* "SICER2/src/count_reads_per_bin.pyx":27
 *             last = bins[0]
 * 
 *         for i in range(len(v)):             # <<<<<<<<<<<<<<
 *             current = v[i]
 ...
 */
    ...
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_14; __pyx_t_13+=1) {
      ...
      /* "SICER2/src/count_reads_per_bin.pyx":28
 * 
 *         for i in range(len(v)):
 *             current = v[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      } else if (unlikely(__pyx_t_15 >= __pyx_v_v.shape[0])) __pyx_t_16 = 0;
      if (unlikely(__pyx_t_16 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_16);
        __PYX_ERR(0, 28, __pyx_L1_error)
      }
      __pyx_v_current = (*((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_v.data) + __pyx_t_15)) )));

      /* "SICER2/src/count_reads_per_bin.pyx":30
 *             current = v[i]
 * 
 *             if current != last:             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_11 = ((__pyx_v_current != __pyx_v_last) != 0);
      if (__pyx_t_11) {

        /* "SICER2/src/count_reads_per_bin.pyx":31
 * 
 *             if current != last:
 *                 bins[nparsed] = current             # <<<<<<<<<<<<<<
 *                 counts[nparsed] = count
 *                 last = current
 */
        __pyx_t_17 = __pyx_v_nparsed;
        __pyx_t_16 = -1;
        if (__pyx_t_17 < 0) {
          __pyx_t_17 += __pyx_v_bins.shape[0];
          if (unlikely(__pyx_t_17 < 0)) __pyx_t_16 = 0;
        } else if (unlikely(__pyx_t_17 >= __pyx_v_bins.shape[0])) __pyx_t_16 = 0;
        if (unlikely(__pyx_t_16 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_16);
          __PYX_ERR(0, 31, __pyx_L1_error)
        }
        *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_bins.data) + __pyx_t_17)) )) = __pyx_v_current;

        /* "SICER2/src/count_reads_per_bin.pyx":32
 *             if current != last:
 *                 bins[nparsed] = current
 *                 counts[nparsed] = count             # <<<<<<<<<<<<<<
 *                 last = current
 *                 count = 1
 */
        __pyx_t_18 = __pyx_v_nparsed;
        __pyx_t_16 = -1;
        if (__pyx_t_18 < 0) {
          __pyx_t_18 += __pyx_v_counts.shape[0];
          if (unlikely(__pyx_t_18 < 0)) __pyx_t_16 = 0;
        } else if (unlikely(__pyx_t_18 >= __pyx_v_counts.shape[0])) __pyx_t_16 = 0;
        if (unlikely(__pyx_t_16 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_16);
          __PYX_ERR(0, 32, __pyx_L1_error)
        }
        *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_counts.data) + __pyx_t_18)) )) = __pyx_v_count;

        /* "SICER2/src/count_reads_per_bin.pyx":33
 *                 bins[nparsed] = current
 *                 counts[nparsed] = count
 *                 last = current             # <<<<<<<<<<<<<<
 *                 count = 1
 ...
 */
        ...
        /* "SICER2/src/count_reads_per_bin.pyx":34
 *                 counts[nparsed] = count
 *                 last = current
 *                 count = 1             # <<<<<<<<<<<<<<
 *                 nparsed += 1
 ...
 */
        ...
        /* "SICER2/src/count_reads_per_bin.pyx":35
 *                 last = current
 *                 count = 1
 *                 nparsed += 1             # <<<<<<<<<<<<<<
 *             else:
 *                 count += 1
 */
        __pyx_v_nparsed = (__pyx_v_nparsed + 1);
 ...
 */
      ...
      /* "SICER2/src/count_reads_per_bin.pyx":37
 *                 nparsed += 1
 *             else:
 *                 count += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "SICER2/src/count_reads_per_bin.pyx":40
 * 
 * 
 ...
 *     return bins_counts
 */
    __pyx_t_6 = __pyx_memoryview_fromslice(__pyx_v_bins, 1, (PyObject *(*)(char *)) __pyx_memview_get_long, (int (*)(char *, PyObject *)) __pyx_memview_set_long, 0);; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_7 = __pyx_memoryview_fromslice(__pyx_v_counts, 1, (PyObject *(*)(char *)) __pyx_memview_get_long, (int (*)(char *, PyObject *)) __pyx_memview_set_long, 0);; if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    ...
    __pyx_t_6 = 0;
    __pyx_t_7 = 0;
    if (unlikely(PyDict_SetItem(__pyx_v_bins_counts, __pyx_v_k, __pyx_t_3) < 0)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  /* "SICER2/src/count_reads_per_bin.pyx":42
 *         bins_counts[k] = (bins, counts)
 * 
 *     return bins_counts             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __Pyx_INCREF(__pyx_v_bins_counts);
  __pyx_r = __pyx_v_bins_counts;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("SICER2.src.count_reads_per_bin.count_reads_per_bin", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_bins, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_counts, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_v, 1);
  __Pyx_XDECREF(__pyx_v_bins_counts);
  __Pyx_XDECREF(__pyx_v_k);
  __Pyx_XDECREF(__pyx_v_bin_arr);
...
/* Python wrapper */
static PyObject *__pyx_pw_6SICER2_3src_19count_reads_per_bin_1count_reads_per_bin(PyObject *__pyx_self, PyObject *__pyx_v_tags); /*proto*/
static PyObject *__pyx_pw_6SICER2_3src_19count_reads_per_bin_1count_reads_per_bin(PyObject *__pyx_self, PyObject *__pyx_v_tags) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("count_reads_per_bin (wrapper)", 0);
  __pyx_r = __pyx_pf_6SICER2_3src_19count_reads_per_bin_count_reads_per_bin(__pyx_self, ((PyObject *)__pyx_v_tags));
...
static PyObject *__pyx_pf_6SICER2_3src_19count_reads_per_bin_count_reads_per_bin(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_tags) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("count_reads_per_bin", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_6SICER2_3src_19count_reads_per_bin_count_reads_per_bin(__pyx_v_tags, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "SICER2.src.count_reads_per_bin.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "SICER2.src.count_reads_per_bin.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "SICER2.src.count_reads_per_bin.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "SICER2.src.count_reads_per_bin._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"count_reads_per_bin", (PyCFunction)__pyx_pw_6SICER2_3src_19count_reads_per_bin_1count_reads_per_bin, METH_O, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_count_reads_per_bin(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_count_reads_per_bin},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcount_reads_per_bin(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcount_reads_per_bin(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_count_reads_per_bin(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_count_reads_per_bin(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_count_reads_per_bin(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_count_reads_per_bin(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("count_reads_per_bin", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_SICER2__src__count_reads_per_bin) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "SICER2.src.count_reads_per_bin")) {
      if (unlikely(PyDict_SetItemString(modules, "SICER2.src.count_reads_per_bin", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "SICER2/src/count_reads_per_bin.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 * cpdef count_reads_per_bin(tags):
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init SICER2.src.count_reads_per_bin", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init SICER2.src.count_reads_per_bin");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
